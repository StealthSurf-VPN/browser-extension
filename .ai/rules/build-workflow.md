...
- Let npm update `package-lock.json` only when a dependency operation explicitly requires it.
- Format changed JavaScript, JSX, JSON, MJS, and CJS files with Biome through `npm run format` before completion.
